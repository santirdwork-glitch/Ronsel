...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FBF3E7] text-[#1F1E1B]">
      {/* NAVEGACIÓN */}
      <nav>
        <div className="flex items-center justify-center px-4 sm:px-6 pt-8 pb-6">
          <Link href="/" className={`${greatVibes.className} text-4xl md:text-5xl lg:text-6xl text-[#2F6E68]`}>
            Ronsel
          </Link>
        </div>
      ...
      <section className="relative h-[80vh] min-h-[500px] md:min-h-[650px] w-full overflow-hidden">
        ...
        <div className={`relative z-10 flex h-full flex-col justify-end px-6 md:px-12 lg:px-16 pb-12 md:pb-16 transition-all duration-700 ${mounted ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}>
          ...
          <Link href="#planes" className="w-fit border border-white px-8 py-3 text-sm uppercase tracking-[0.2em] text-white hover:bg-white hover:text-[#1F1E1B] transition-colors">
            Elige tu plan
          </Link>
        </div>
      </section>
      ...
      {/* FRANJA DE VALORES */}
      <section className="bg-[#2F6E68] px-6 py-12 md:py-16">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center px-6 py-12 md:py-16 lg:px-24">
          ...
          <Link href="#planes" className="group flex w-fit items-center gap-4 text-sm uppercase tracking-[0.2em] text-[#2F6E68]">
            Descubre los planes 
      ...
      {/* ENFOQUE INTEGRAL */}
      <section className="bg-[#1F1E1B] px-6 py-16 md:py-24 lg:py-32">
      ...
      <section id="planes" className="bg-white px-6 py-16 md:py-24 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <h2 className={`${playfair.className} mb-12 md:mb-16 text-center italic leading-[1] text-[#1F1E1B]`} 
              style={{ fontSize: "clamp(2.2rem, 8vw, 5rem)" }}>
            Elige tu camino
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {planes.map((plan) => (
              <Link href={plan.href} key={plan.nombre} className="group flex flex-col border border-black/5 hover:shadow-xl transition-shadow">
