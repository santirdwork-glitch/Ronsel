  ...
  return (
    <div className="min-h-screen bg-[#FBF3E7]">
      ...
      <section className="mx-auto grid max-w-6xl grid-cols-1 gap-14 px-6 py-20 lg:grid-cols-2 lg:gap-20">
        <div className="overflow-hidden">
          <img src="https://picsum.photos/seed/ronsel-transforma-hero/900/1100" alt="" className="aspect-[4/5] w-full object-cover transition-transform duration-500 hover:scale-105" />
        </div>
